...
# Go up from test_metadata_fixtures.py to project root, then to tests/fixtures
FIXTURE_MP3 = Path(__file__).parent.parent.parent.parent.parent / "tests" / "fixtures" / "test.mp3"
