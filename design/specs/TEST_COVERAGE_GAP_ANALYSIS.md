...
| `src\business\services\metadata_service.py` | `MetadataService.get_raw_tags` | 40% | 🔴 |
| `src\business\services\metadata_service.py` | `MetadataService.write_tags` | 93% | ✅ |
...
| `src\presentation\views\main_window.py` | `MainWindow._on_playlist_changed` | 100% | ✅ |
...
| `src\presentation\views\main_window.py` | `MainWindow._restore_playlist` | 85% | ⚠️ |
...
| `src\presentation\widgets\library_widget.py` | `LibraryWidget._toggle_status` | 96% | ✅ |
| `src\presentation\widgets\library_widget.py` | `LibraryWidget._delete_selected` | 100% | ✅ |
| `src\presentation\widgets\library_widget.py` | `LibraryWidget._on_table_double_click` | 100% | ✅ |
| `src\presentation\widgets\library_widget.py` | `LibraryWidget._emit_add_to_playlist` | 100% | ✅ |
